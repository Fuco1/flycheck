...
(defun flycheck-parse-rust-filter-json (output)
  "Return parsed JSON data from OUTPUT generated by Cargo or rustc.

When JSON output is requested, Cargo and rustc both emit a mix of
plain text lines and JSON lines.  This function ignores the plain
text lines, and parses the JSON lines before returning them in a
list."
  (let ((json-array-type 'list)
        (json-false nil)
...
https://github.com/rust-lang/rust/blob/master/src/libsyntax/json.rs#L67-L139"
  (seq-mapcat (lambda (msg)
              ...
              (flycheck-parse-rust-filter-json output)))
...
https://github.com/rust-lang/cargo/blob/master/src/cargo/util/machine_message.rs#L20-L31"
  (let ((errors))
    (dolist (msg (flycheck-parse-rust-filter-json output))
      (let-alist msg
